...
_parser.add_argument("-a", "--addr_width", type = int, default = 7,
        help = "Bit width of the address buses of the CORE in the multi-mode memory")
_parser.add_argument("-d", "--data_width", type = int, default = 8,
        help = "Bit width of the data buses of the CORE in the multi-mode memory")
_parser.add_argument("-w", "--word_width", type = int, default = 8,
...
try:
    ...
    builder.connect(builder.create_input("din", args.data_width, Orientation.east, (0, 0)), inst.pins["din"])
    ...
    builder.connect(inst.pins["dout"], builder.create_output("dout", args.data_width, Orientation.east, (0, 1)))
    bram = builder.commit()
...
Flow(
        Materialization("frame", word_width = args.word_width),
        Translation(),
